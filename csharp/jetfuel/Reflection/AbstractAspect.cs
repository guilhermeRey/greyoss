...
namespace EixoX
{
        ...
        where TMember : AspectMember
    {
        ...
        public CaseStrategy _CaseStrategy { get; set; }

        /// <summary>
        /// Creates a new aspect for a member accessor.
        /// </summary>
        ...
        public AbstractAspect(Type dataType)
        {
            ...
            object[] cases = dataType.GetCustomAttributes(typeof(CasePattern), true);
            this._CaseStrategy = cases == null || cases.Length == 0 ? CaseStrategy.Default : ((CasePattern)cases[0]).Strategy;
